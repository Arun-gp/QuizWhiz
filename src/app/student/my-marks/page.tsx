            ...
            <Card>
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                            {student?.marks && Object.entries(student.marks).length > 0 ? (
                                Object.entries(student.marks).map(([quizId, score]) => {
                                ...
                                <TableRow>
                                    <TableCell colSpan={2} className="text-center">No marks yet. Take a quiz to see your scores!</TableCell>
                                </TableRow>
                            )}
                        </TableBody>
                    </Table>
